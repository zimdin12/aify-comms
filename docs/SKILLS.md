...
Managed Codex defaults to `gpt-5.5` with `high` reasoning effort unless the dashboard settings or a teammate/spawn override specify a different model/effort.
