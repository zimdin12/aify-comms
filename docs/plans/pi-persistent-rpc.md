...
- [x] Phase 5 — Docs (DECISIONS.md entry; install.pi.md Delivery path rewrite + watchdog section; debug SKILL.md + .agents mirror updated with synthesized-terminal explainer and watchdog refusal flow)
