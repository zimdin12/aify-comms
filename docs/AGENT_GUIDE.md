...
- Settings should stay grouped by operator intent: appearance, managed runtime defaults and delivery toggles, work-loop policy, and maintenance/lease cleanup windows.
