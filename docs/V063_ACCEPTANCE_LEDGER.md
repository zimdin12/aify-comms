...
- **Candidate: `5c311754`** -- the commit the tested tree BECAME, written after that commit exists
...
`TIME_WAIT` was **342** before the python run and **12,185** after it, against this host's 16,384-port
