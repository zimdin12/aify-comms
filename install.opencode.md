...
Use aify-comms when you want Slack-like coordination for coding agents: direct messages, channels, shared artifacts, and active dispatch.
...
- The `aify-comms` local MCP server for OpenCode
