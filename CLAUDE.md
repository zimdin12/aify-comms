...
```bash
python -m pytest service/tests scripts/tests -q -n 8 --dist loadfile # 5357 tests, 3 skipped (+10482 subtests)
cd mcp/stdio && node tests/run-all.mjs                 # 365 suites, 2 skipped tests (named in its output)
