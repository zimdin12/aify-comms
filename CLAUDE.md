...
```bash
python -m pytest service/tests -q -n 8 --dist loadfile # 5603 tests (+10901 subtests)
...
cd ~/projects/aify-env    && npm test                          # 1682 tests, 1 skipped; `npm test`
