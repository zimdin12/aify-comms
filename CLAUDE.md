...
```bash
python -m pytest service/tests -q -n 8 --dist loadfile # 5627 tests (+10956 subtests)
...
cd ~/projects/aify-env    && npm test                          # 1697 tests, 1 skipped; `npm test`
