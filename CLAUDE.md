...
```bash
python -m pytest service/tests -q -n 8 --dist loadfile # 5517 tests (+10802 subtests)
...
cd ~/projects/aify-env    && npm test                          # 1514 tests, 1 skipped; `npm test`
