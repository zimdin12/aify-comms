...
```bash
python -m pytest service/tests scripts/tests -q -n 8 --dist loadfile # 4843 tests, 25 skipped (+10693 subtests; 21 are deprecated pi tests)
...
cd service/new_dashboard && node --test *.test.mjs     # 1793 tests
```
