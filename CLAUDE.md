...
cd mcp/stdio && node tests/run-all.mjs                 # 360 suites, 1 skipped test (named in its output)
...
cd ~/projects/aify-env    && npm test                          # 1531 tests, 1 skipped; `npm test`
