...
cd ~/projects/aify-env    && npm test                          # 1756 tests, 1 skipped; `npm test`
                                                           # NOT a bare `node --test`: the script
