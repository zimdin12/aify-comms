...
```bash
cd ~/projects/aify-wrapper && node --test tests/*.test.js   # 202 tests
cd ~/projects/aify-env    && npm test                          # 1095 tests, 1 skipped; `npm test`
