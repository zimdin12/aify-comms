...
```bash
python -m pytest service/tests scripts/tests -q -n 8 --dist loadfile # 5784 tests, 3 skipped (+11232 subtests)
...
```bash
cd ~/projects/aify-wrapper && npm test                      # 491 tests, 49 skipped on Windows. `npm test`
