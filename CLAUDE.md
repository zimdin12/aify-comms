...
cd service/new_dashboard && node --test *.test.mjs     # 1737 tests
```
...
```bash
cd ~/projects/aify-wrapper && node --test tests/*.test.js   # 247 tests, 1 skipped
