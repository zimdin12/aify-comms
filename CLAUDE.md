...
```bash
python -m pytest service/tests scripts/tests -q -n 8 --dist loadfile # 4837 tests, 25 skipped (+10687 subtests; 21 are deprecated pi tests)
...
cd service/new_dashboard && node --test *.test.mjs     # 1792 tests
```
