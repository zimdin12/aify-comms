...
```bash
python -m pytest service/tests -q -n 8 --dist loadfile # 5501 tests (+10780 subtests)
...
cd ~/projects/aify-env    && npm test                          # 1276 tests, 1 skipped; `npm test`
