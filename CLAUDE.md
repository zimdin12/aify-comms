...
```bash
python -m pytest service/tests -q                      # 4571 tests (+9156 subtests)
cd mcp/stdio && node tests/run-all.mjs                 # 373 suites, 1 skipped test (named in its output)
cd service/new_dashboard && node --test *.test.mjs     # 1273 tests
```
