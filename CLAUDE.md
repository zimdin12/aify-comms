...
```bash
python -m pytest service/tests scripts/tests -q -n 8 --dist loadfile # 5730 tests, 3 skipped (+11112 subtests)
...
cd ~/projects/aify-env    && npm test                          # 1815 tests, 2 skipped; `npm test`
                                                           # NOT a bare `node --test`: the script
