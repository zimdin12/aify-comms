...
cd mcp/stdio && node tests/run-all.mjs                 # 373 suites, 2 skipped tests (named in its output)
...
```bash
cd ~/projects/aify-wrapper && npm test                      # 503 tests, 49 skipped on Windows. `npm test`
