...
```bash
python -m pytest service/tests scripts/tests -q -n 8 --dist loadfile # 5707 tests, 3 skipped (+11036 subtests)
...
```bash
cd ~/projects/aify-wrapper && npm test                      # 382 tests, 1 skipped. `npm test`
...
cd ~/projects/aify-env    && npm test                          # 1764 tests, 1 skipped; `npm test`
                                                           # NOT a bare `node --test`: the script
