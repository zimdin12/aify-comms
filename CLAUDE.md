...
`install.sh` (2,978 lines, down from 4,371 once all four wrapper bodies became template files) and `service/new_dashboard/styles.css` (1,844) are non-test source over the
