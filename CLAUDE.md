...
```bash
python -m pytest service/tests -q -n 8 --dist loadfile # 5408 tests (+10587 subtests)
...
cd ~/projects/aify-env    && npm test                          # 1081 tests, 1 skipped; `npm test`
