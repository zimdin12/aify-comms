...
```bash
python -m pytest service/tests -q -n 8 --dist loadfile # 5558 tests (+10846 subtests)
...
cd ~/projects/aify-env    && npm test                          # 1666 tests, 1 skipped; `npm test`
