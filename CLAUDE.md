...
```bash
python -m pytest service/tests -q                      # 4943 tests (+9919 subtests)
cd mcp/stdio && node tests/run-all.mjs                 # 396 suites, 1 skipped test (named in its output)
cd service/new_dashboard && node --test *.test.mjs     # 1437 tests
```
