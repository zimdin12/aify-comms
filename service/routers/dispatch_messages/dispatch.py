...
from service.routers.dispatch_messages.shared import (  # noqa: F401
    VALID_STATUSES,
...
async def _claim_dispatch_once(req: DispatchClaimRequest, request: Request):
    ...
    try:
        ...
        # See _borrowed_channel_claim_runtimes() and _bridge_claim_block_reason: managed
        ...
        channel_claim = agent_runtime in _borrowed_channel_claim_runtimes() and "channel" in supported_modes
    ...
    try:
        ...
        for recipient_id in recipients:
            ...
            if row:
                ...
                elif runtime in _borrowed_channel_managed_runtimes():
