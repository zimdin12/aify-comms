...
from service.models import DispatchClaimRequest, DispatchControlClaimRequest, DispatchControlRequest, DispatchControlUpdate, DispatchRequest, DispatchRunUpdate
from service.routers.dispatch_messages.shared import VALID_STATUSES, _NATIVE_MANAGED_RUNTIMES, _adopt_live_resident_driver, _agent_tombstone, _append_terminal_control, _auto_handoff_subject_for_run, _borrowed_dispatch_terminal_statuses, _borrowed_merged_dispatch_header, _borrowed_unthreaded_handoff_window_ms, _bridge_claim_block_reason, _close_reconcilable_delivered_runs, _close_steered_contracts_for_parent_run, _dispatch_conversation_context, _dispatch_reply_pending, _dispatch_reply_state, _has_claimable_steerable_run, _is_replaceable_auto_handoff_message, _machine_ids_same_host, _mark_dispatch_run_answered, _mark_dispatch_source_messages_read, _message_satisfies_reply_contract, _pending_dispatch_count, _record_channel_sidecar_heartbeat, _release_stale_console_owner_for_claim, _active_terminal_for_agent, _agent_execution_mode, _append_dispatch_control, _auto_return_resident_to_managed_if_possible, _clear_turn_busy_if_no_open_reply_owing_run, _coldstart_refusal_message, _coldstart_spawn_request_for_dispatch, _console_dispatch_input_body, _create_dispatch_runs, _delete_messages_by_ids, _delete_messages_where, _dispatch_fix_hint, _dispatch_requires_reply, _ensure_managed_pty_for_dispatch, _fail_pending_controls_for_run, _finalize_dispatch_runs, _get_blocking_active_run, _get_dispatch_state_for_agent, _get_recipient_info, _has_claimable_spawn_request, _has_live_managed_wrapper_child, _is_delivery_only_claude_run, _link_reply_message_to_dispatch_run, _managed_environment_unavailable_reason, _managed_terminal_backing_enabled, _managed_via_wrapper_for_runtime, _message_type_expects_reply, _mirror_missing_dispatch_handoff, _preflight_live_send_recipients, _primary_result_message_id, _record_terminal_delivery_contract, _reject_sender_truncated_body, _resolve_recipient_ids, _resolve_reply_parent_message_id, _run_contract_reminders_once, _touch_agent, _touch_current_agent_session, _turn_busy_holds_delivery, _wake_agent
