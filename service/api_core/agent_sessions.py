...
# _upsert_resident_agent_session moved to service/api_core/resident_session_upsert.py in
# v0.5.4 — registration mints a resident session, which is a different story from a spawn
# becoming a worker, and this module is about reading and touching sessions rather than
# minting them.
