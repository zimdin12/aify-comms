...
This module is the ONLY place Python declares those words. `api_v2.py` imports from here, so there is
no second Python copy to drift. The JS bridge keeps its own literal map — it has to, because
