...
//
// It once failed the harness's module-scope-browser-globals check, which read `document` here as
// load-time code -- it is not, it runs only when called, and the check was corrected rather than this
// line reworded to suit it.
