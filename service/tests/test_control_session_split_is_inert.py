...
EDITED_SINCE = [
    ...
    #: and then reproduced the SAME race surviving inside the route, because the guard's SELECT ran
    #: outside any transaction. `was` is empty because this code is NEW rather than changed.
    (
