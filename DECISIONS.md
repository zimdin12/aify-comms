...
- **Setting** (`service/api_core/settings.py`, commit `697d526`): `manual_session_mode: false` in `DEFAULT_SETTINGS`. Default off — TTY auto-detect remains the sole source of truth unless the operator opts in.
