...
const UNTESTED_EXPORT_BACKLOG = [
  ...
  "mcp/stdio/doctor-predicates.js#ENV_CONNECTED_STATES",
  "mcp/stdio/doctor-predicates.js#ENV_KNOWN_STATES",
  ...
  "mcp/stdio/hermes-managed-gateway-session.js#_resetHermesGatewayPoolForTests",
  "mcp/stdio/hermes-managed-gateway-session.js#getOrCreateHermesGatewaySession",
  "mcp/stdio/hermes-managed-gateway-session.js#managedHermesUsesGateway",
