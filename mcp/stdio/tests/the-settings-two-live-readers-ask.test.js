...
// `env-listing.mjs`, which is live: `env-processes-check.mjs` reads it to list what a host is running.
// (`delegation-setting.mjs` was the other, until 0.7.0 retired the switch it read.) `every-module-is-imported-by-a-test` and `every-export-is-named-by-a-test`
