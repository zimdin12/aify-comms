...
test("the bridge still uses both", () => {
  // Asserted across the bridge rather than against server.js: their only callers moved to
  // `agent-reporting-tools.mjs` one commit after a server.js-pinned version of this was written.
